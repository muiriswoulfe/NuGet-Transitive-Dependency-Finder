...
public class ProgramInitializerUnitTests
{
    ...
    [InlineData("-p Project.csproj -f .*")]
    [InlineData("-p Project.csproj --filter .*")]
    [InlineData("-p Project.csproj -a -f .*")]
    ...
    [InlineData("--projectOrSolution Project.csproj -f .*")]
    [InlineData("--projectOrSolution Project.csproj --filter .*")]
    [InlineData("--projectOrSolution Project.csproj --all --filter .*")]
    ...
    [InlineData("--projectOrSolution Project.csproj --filter .* --filter .*")]
    ...
    [InlineData("-p Project.csproj -f .* -f .*")]
