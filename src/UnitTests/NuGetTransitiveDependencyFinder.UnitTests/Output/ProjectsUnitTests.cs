...
public class ProjectsUnitTests
{
    ...
    /// <summary>
    /// Tests than when <see cref="Projects.IsAddValid(Project?)"/> is called with a <see cref="Project"/> comprising
    ...
    /// <summary>
    /// Tests that when <see cref="Base{Project}.HasChildren"/> is called for a <see cref="Projects"/> object comprising
    /// children without children, it returns <see langword="false"/>.
    /// </summary>
    [AllCulturesFact]
    ...
    /// <summary>
    /// Tests that when <see cref="Base{Project}.HasChildren"/> is called for a <see cref="Projects"/> object comprising
    /// children with children, it returns <see langword="true"/>.
    /// </summary>
    [AllCulturesFact]
    ...
    /// <summary>
    /// Tests that when <see cref="Base{Project}.HasChildren"/> is called for a <see cref="Projects"/> object comprising
    /// children for which a subset have children, it returns <see langword="true"/>.
    /// </summary>
    [AllCulturesFact]
    ...
    /// <summary>
    /// Tests that when <see cref="Base{Project}.SortedChildren"/> is called for a <see cref="Projects"/> object
    /// comprising children added after an initial call to <see cref="Base{Project}.SortedChildren"/>, it returns the
