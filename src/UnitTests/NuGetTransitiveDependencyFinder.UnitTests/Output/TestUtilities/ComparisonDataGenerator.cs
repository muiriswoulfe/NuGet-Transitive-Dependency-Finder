...
internal static class ComparisonDataGenerator
{
    ...
    /// <param name="lesserValue">The lesser test value, which occurs prior to <see paramref="defaultValue"/> according
    /// to an ordered sort.</param>
    /// <param name="supplementalTestData">The supplemental class-specific test data to be added to the generic test
    /// data.</param>
    ...
    /// <typeparam name="TValue">The type to use for the comparisons.</typeparam>
    /// <param name="operatorTestData">The operator test data to be filtered.</param>
    /// <param name="match">The match to apply to <paramref name="operatorTestData"/> when filtering the data.</param>
