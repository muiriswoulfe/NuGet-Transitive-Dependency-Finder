...
public class ProjectUnitTests
{
    ...
    /// <summary>
    /// Tests that when <see cref="IEquatable{Project}.Equals(Project)"/> is called with different values, it returns
    ...
    /// <summary>
    /// Tests that when <see cref="Project.GetHashCode()"/> is called with identical objects, it returns the same value
    /// each time.
    /// </summary>
    ...
    /// <summary>
    /// Tests than when <see cref="Project.IsAddValid(Framework?)"/> is called with a <see cref="Framework"/> comprising
    /// children, it returns <see langword="true"/>.
    /// </summary>
    [AllCulturesFact]
    ...
    /// <summary>
    /// Tests that when <see cref="Base{Framework}.SortedChildren"/> is called for a <see cref="Project"/> object not
    ...
    /// <summary>
    /// Tests that when <see cref="Base{Framework}.SortedChildren"/> is called for a <see cref="Project"/> object
    /// comprising children added after an initial call to <see cref="Base{Framework}.SortedChildren"/>, it returns the
