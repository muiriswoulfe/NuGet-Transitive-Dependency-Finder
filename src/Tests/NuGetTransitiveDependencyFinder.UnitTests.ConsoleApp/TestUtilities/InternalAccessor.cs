...
/// <c>NuGetTransitiveDependencyFinder</c> project. It is not possible to make that project's <see langword="internal"/>
/// functionality visible to the current project via <see cref="InternalsVisibleToAttribute"/> as doing so leads to a
/// class name duplication related to <c>NuGetTransitiveDependencyFinder.Properties.AssemblyAttributes</c>.</remarks>
