...
{
    /// <summary>
    /// The <see cref="Action{ILoggerBuilder}"/>, which defines the logging action for both the current application and
    /// the NuGet Transitive Dependency Finder library.
    /// </summary>
    ...
    /// <summary>
    /// Gets the <see cref="IProgramRunner"/> from the <see cref="IServiceProvider"/> dependency injection container.
    /// </summary>
