...
{
    /// <summary>
    /// Gets a localized string corresponding to the description of the "--all" parameter, which is displayed as part of
    /// the help message.
    /// </summary>
    ...
    /// <summary>
    /// Gets a localized string corresponding to the description of the  "--filter" parameter, which is displayed as
