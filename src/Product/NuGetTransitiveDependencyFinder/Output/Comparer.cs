...
internal static class Comparer
{
    ...
    /// <param name="function">The comparison logic specific to <c>TValue</c>, which takes two objects of type
    /// <c>TValue</c> and returns an <see cref="int"/>.</param>
    /// <param name="className">The name of the calling class, which will be used within the exception message.</param>
    ...
    /// <summary>
    /// Maps a value returned from <see cref="StringComparer.Compare(string?, string?)"/>, which can span a considerable
    /// range, to the range [-1, 1] expected from
