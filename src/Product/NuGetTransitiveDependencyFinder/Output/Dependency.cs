...
public sealed class Dependency : IComparable, IComparable<Dependency>, IEquatable<Dependency>
{
    ...
    /// <param name="left">The left operand to compare.</param>
    /// <param name="right">The right operand to compare.</param>
    /// <returns><see langword="true"/> if <see paramref="left"/> is not equal to <see paramref="right"/>; otherwise,
    /// <see langword="false"/>.</returns>
    public static bool operator !=(Dependency? left, Dependency? right) =>
    ...
    /// <param name="left">The left operand to compare.</param>
    /// <param name="right">The right operand to compare.</param>
    /// <returns><see langword="true"/> if <see paramref="left"/> is greater than <see paramref="right"/>; otherwise,
    /// <see langword="false"/>.</returns>
    public static bool operator >(Dependency? left, Dependency? right) =>
    ...
    /// <param name="left">The left operand to compare.</param>
    /// <param name="right">The right operand to compare.</param>
    /// <returns><see langword="true"/> if <see paramref="left"/> is greater than or equal to <see paramref="right"/>;
    /// otherwise, <see langword="false"/>.</returns>
    public static bool operator >=(Dependency? left, Dependency? right) =>
        Comparer.IsGreaterOrEqual(left, right, ComparisonFunction);

    /// <summary>
    /// Compares the current object to <see paramref="other"/>, returning an integer that indicates their relationship.
    /// </summary>
    /// <param name="other">The object against which to compare the current object.</param>
    /// <returns>A value less than zero if the current object is less than <see paramref="other"/>, zero if the current
    /// object is equal to <see paramref="other"/>, or a value greater than zero if the current object is greater than
    /// <see paramref="other"/>.</returns>
    public int CompareTo(Dependency? other) =>
        Comparer.CompareTo(this, other, ComparisonFunction);

    /// <inheritdoc/>
    /// <exception cref="ArgumentException"><paramref name="obj"/> is not of type <see cref="Dependency"/>.</exception>
